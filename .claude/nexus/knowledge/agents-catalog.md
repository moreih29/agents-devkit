...
| 이름 | 역할 | model | 비고 |
|------|------|-------|------|
| **Principal** | 리서치 방향/아젠다/태스크 소유, 확증편향 방지 | opus | READ-ONLY, task lifecycle 소유자 |
| **Postdoc** | 방법론 설계, 증거 평가, synthesis 문서 작성 | opus | Write 허용 (synthesis.md), Bash 금지 |
| **Researcher** | 웹 검색, 독립 조사, 출처 인용 보고 | sonnet | 모든 도구 허용, WebSearch 3회 탈출조건 |
