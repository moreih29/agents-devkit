...
2. 파일 하나 찾는 Scout에게 아키텍처 결정 근거까지 주입하는 것은 비효율
...
### 에이전트 매핑
- minimal: Scout, Scribe (탐색/기록에 배경지식 불필요)
- standard: Artisan, Tinker, Weaver, Sentinel, Herald, Palette, Mason (작업에 프로젝트 맥락 필요)
- full: Steward, Compass, Strategist, Analyst, Lens, Critic (전체 그림 필요)
