...
- **Workflow**: Parallel, Pipeline, Cruise 프리미티브
  - Cruise = Pipeline + Sustain 복합 워크플로우
  - `lat_state_clear({ key: "cruise" })` 단일 해제
- **Agents**: 11개 (Phase 1~3)
  - Phase 2: Strategist, Lens, Analyst, Tinker
  - Phase 3: Weaver, Scribe
...
- Cruise clear 시 불필요한 cruise.json 탐색 제거
...
- **Agents**: Steward, Artisan, Scout, Compass, Sentinel (Phase 1)
- **Workflow**: Sustain (Stop 차단, 지속 실행)
