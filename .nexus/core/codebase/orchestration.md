...
A single gate.ts module handles 7 events. Event discrimination: `process.env.NEXUS_EVENT` distinguishes SessionStart/SubagentStart/Stop; otherwise field presence (tool_name → PreToolUse, prompt → UserPromptSubmit, neither → Stop).
